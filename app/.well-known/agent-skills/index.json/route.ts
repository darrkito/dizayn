...
export async function GET() {
  return apiJson({
    ...
    version: "0.2.0",
    publisher: { name: "Dizayn", url: "https://www.dizayn.com.mx", contact: "sebasesc5@gmail.com" },
    skills: [
      {
        ...
        url: "https://www.dizayn.com.mx/.well-known/agent-skills/answer-service-questions/SKILL.md",
        version: "1.0.0",
      },
    ],
  });
