    ...
    entries: [
      {
        ...
        description: "Read-only JSON API for Dizayn's service catalog and blog, including real client case studies.",
      ...
      },
      {
        ...
        description: "Model Context Protocol server exposing services, blog posts/case studies and contact requests as callable tools.",
        type: "application/mcp-server-card+json",
        url: `${SITE_URL}/.well-known/mcp/server-card.json`,
        representativeQueries: ["get details on Dizayn's SEO service", "contact Dizayn about a new website", "show me a real client case study"],
      },
      {
        identifier: "urn:air:dizayn.com.mx:agent:a2a",
        displayName: "Dizayn Assistant (A2A)",
        description: "Agent-to-Agent endpoint that answers service, case-study and contact questions from Dizayn's real content.",
        type: "application/json",
        url: `${SITE_URL}/.well-known/agent-card.json`,
        representativeQueries: ["what marketing services does Dizayn offer", "how do I contact Dizayn", "do you have real case studies"],
      },
    ],
  });
}
